...
public class ShapeApplet extends JApplet
	 ...
	 *
	 * @param evt Mouse event that contains the position of the click.
	 */
	 ...
	 * but only react when the control key is pressed.
	 */
	 ...
	 * but only react when the control key is released.
	 */
	...
	/**
	 * Implements the actions that should be taken when an item
	...
	public void actionPerformed(ActionEvent event) {
		...
		if ("Rectangle" == event.getActionCommand())
			...
			panel.makeTestShapes(3);
		   	...
		   	System.out.print("Missed menu option.");
