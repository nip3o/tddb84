...
/**
 * The main class in the game, initializes the snake and the game panel
 * and starts the game.
 *
...
public class GameApplet extends JApplet implements ActionListener, KeyListener {
	...
	public void init() {
		...
		this.resize(GamePanel.getDimension());
	...
	/**
	 * Implements the actions that should be taking when an item in
	 * the menu is chosen.
	 *
