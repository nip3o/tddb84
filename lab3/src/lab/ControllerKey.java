...
/**
 * Controls the snake depending on the arrow keys pressed and make
 * the snake move forward according to its speed.
 *
...
public class ControllerKey implements Controller {
	...
	/**
	 * Sets the moving direction of the snake and check if it is
	 * a legal direction.
	 */
